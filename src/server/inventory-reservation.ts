...
const MAXIMUM_RESERVATION_QUANTITY =
    99;
...
export class InventoryReservationError
    extends Error {
...
function mapReservationItem(
    row:
        InventoryReservationItemDatabaseRow,
): InventoryReservationItem {
    return {
        inventoryItemId:
            String(
...
function mapReservation(
    row:
        InventoryReservationDatabaseRow,
    items:
        InventoryReservationItem[],
): InventoryReservation {
    return {
