...
export const shippingPolicyDocument: LegalDocument = {
  ...
  description: `Review the current prelaunch status of ${businessConfig.shortName} shipping, fulfillment, tracking, and delivery procedures.`,

  introduction: `${businessDisplayName} is not yet accepting commercial website orders. The shipping configuration currently used for development and Stripe Sandbox testing does not create a public shipping offer, rate promise, delivery commitment, or commercial fulfillment agreement.`,
  ...
  sections: [
    ...
    {
      id: 'planned-destinations',

      title: '2. Planned shipping destinations',
    ...
    {
      id: 'rates-and-free-shipping',

      title: '3. Shipping charges and free-shipping conditions',
...

    {
      ...
      title: '5. Carrier and service selection',
...

    {
      ...
      title: '6. Shipping addresses and corrections',
...

    {
      ...
      title: '8. Delayed, damaged, incomplete, or missing shipments',
...

    {
      ...
      title: '9. Information the final policy will include',
  ...
  relatedLinks: [
    {
      ...
      description: 'Review the current status of returns, refunds, and cancellations.',
    },

    {
      ...
      description: `Send a future order or shipping question to ${businessConfig.ordersEmail}.`,
    },

    {
      label: 'Product-Issue Support',

      href: `mailto:${businessConfig.supportEmail}`,

      description: `Report a future damaged, incorrect, incomplete, or missing product to ${businessConfig.supportEmail}.`,
    },
  ],
};
