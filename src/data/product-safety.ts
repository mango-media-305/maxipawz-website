export type SafetyTone = 'brand' | 'accent' | 'sand';
...
export type ProductChecklistIcon = 'play' | 'walk' | 'feeding' | 'care';
...
export const productSafetySections: SafetySection[] = [
  {
    ...
    note: 'Size labels are not universal. Compare measurements with the information provided for the individual product.',
  },
...

  {
    ...
    note: 'Some products may be appropriate only while a person is actively participating or watching.',
  },

  {
    ...
    note: 'No pet product should automatically be treated as indestructible.',
  },
