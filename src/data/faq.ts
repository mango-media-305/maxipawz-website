export type FaqGroupIcon = 'storefront' | 'products' | 'orders' | 'help';

export type FaqGroupTone = 'brand' | 'accent' | 'sand';
...
export function getFaqGroups(isStoreLive: boolean): FaqGroup[] {
  const groups: FaqGroup[] = [
    {
      id: 'about-maxipawz',

      eyebrow: isStoreLive ? 'Store Information' : 'Coming Soon',
      ...
      items: isStoreLive ? liveStorefrontItems : prelaunchStorefrontItems,
    },

    {
      ...
      description: 'Answers about choosing, using, inspecting, and learning about pet products.',
  ...
  if (isStoreLive) {
    groups.push({
      ...
      description: 'General answers for purchases and order-related support.',
