...
export type LegalDocumentIcon = 'privacy' | 'terms' | 'shipping' | 'returns' | 'accessibility';

export type LegalDocumentTone = 'brand' | 'accent' | 'sand';
...
const commonRelatedLinks: LegalLink[] = [
  {
    label: `Contact ${businessConfig.shortName}`,

    href: businessConfig.contactHref,

    description: 'Send a privacy, policy, accessibility, or website question.',
  },

  {
    ...
    description: `Find general information about ${businessConfig.shortName} and the upcoming store.`,
  },

  {
    ...
    description: 'Review general guidance for choosing and using pet products.',
  },
];
...
export const privacyPolicy: LegalDocument = {
  ...
  description: `Learn what information ${businessConfig.shortName} currently collects, why it is used, and the choices available to website visitors.`,

  introduction: `This Privacy Policy explains how ${businessDisplayName} handles information submitted through this prelaunch website and information processed while operating, protecting, measuring, and improving the website. It describes the website’s current functionality and will be reviewed again before commercial checkout or additional customer-data features are enabled.`,
  ...
  sections: [
    ...
    {
      id: 'forms-and-notifications',

      title: '3. Website forms and notifications',
...

    {
      ...
      title: '4. Technical and operational information',
...

    {
      ...
      notice: `${businessConfig.shortName} does not currently sell personal information submitted through its website forms.`,
    },

    {
      id: 'email-communications',

      title: '7. Email communications and launch updates',
...

    {
      ...
      title: '8. Analytics and website-experience measurement',
      ...
      notice: `${businessConfig.shortName} does not intentionally send names, email addresses, message contents, payment information, or other directly identifying form-field values to analytics services as custom event parameters.`,
    },

    {
      id: 'future-checkout',

      title: '9. Future checkout and payment processing',
...

    {
      ...
      title: '12. Your choices and privacy requests',
...

    {
      ...
      title: '13. Changes and contact information',
  ...
  relatedLinks: [
    {
      ...
      description: `Review the rules that apply when using the ${businessConfig.shortName} website.`,
    },

    {
      ...
      description: 'Learn about our approach to website accessibility.',
    },

    {
      label: 'Privacy Email',

      href: `mailto:${businessConfig.privacyEmail}`,

      description: `Send a privacy request to ${businessConfig.privacyEmail}.`,
    },
  ],
};
...
export const termsPolicy: LegalDocument = {
  ...
  description: `Review the terms that apply when accessing and using the ${businessConfig.shortName} prelaunch website.`,

  introduction: `These Website Terms of Use govern access to the ${businessConfig.publicName} website. The current website is informational and prelaunch. Commercial terms will be added or updated before products are offered for purchase.`,
  ...
  sections: [
...

    {
      ...
      notice: 'No purchase agreement is created through the current prelaunch website.',
    },

    {
      id: 'business-identity',

      title: '3. Business identity',
...

    {
      ...
      title: '6. Website and brand content',
...

    {
      ...
      title: '7. Messages, suggestions, and submissions',
...

    {
      ...
      title: '8. Pet information and educational content',
...

    {
      ...
      title: '10. Website availability and changes',
...

    {
      ...
      title: '13. Future commercial terms',
  ...
  relatedLinks: [
    {
      ...
      description: 'Learn how information submitted through the website is handled.',
    },

    {
      ...
      description: 'Review our approach to accessible website use.',
    },
...
export const shippingPolicy: LegalDocument = {
  ...
  description: `Review the current prelaunch status of ${businessConfig.shortName} shipping and fulfillment.`,

  introduction: `The ${businessConfig.publicName} online store is not yet accepting commercial orders. Shipping destinations, rates, processing commitments, delivery estimates, carrier procedures, and fulfillment rules remain under review.`,
  ...
  sections: [
...

    {
      ...
      title: '3. Future shipping addresses',
...

    {
      ...
      title: '4. Tracking and delivery information',
    ...
    {
      id: 'shipping-problems',

      title: '5. Future shipping problems',
  ...
  relatedLinks: [
    {
      ...
      description: 'Review the current status of returns, cancellations, and refunds.',
    },

    {
      label: 'Order Support Email',

      href: `mailto:${businessConfig.ordersEmail}`,

      description: `Send a future order question to ${businessConfig.ordersEmail}.`,
    },

    {
      ...
      description: 'Send a question about the future shopping experience.',
    },
  ],
};
...
export const returnPolicy: LegalDocument = {
  ...
  description: `Review the current prelaunch status of ${businessConfig.shortName} returns, cancellations, exchanges, and refunds.`,

  introduction: `The ${businessConfig.publicName} online store is not yet accepting commercial purchases. No active return window, exchange program, refund timeline, cancellation guarantee, or return-shipping procedure currently applies to website purchases.`,
  ...
  sections: [
...

    {
      ...
      title: '2. Planned manual request process',
...

    {
      ...
      title: '3. Information the final policy will include',
...

    {
      ...
      title: '4. Information a future request may require',
...

    {
      ...
      title: '6. Future order changes and cancellations',
...

    {
      ...
      title: '7. Policy updates and contact',
  ...
  relatedLinks: [
    {
      ...
      description: 'Review the current shipping and fulfillment status.',
    },

    {
      ...
      description: 'Review guidance for inspecting and using pet products.',
    },

    {
      label: 'Returns and Product Issues',

      href: `mailto:${businessConfig.supportEmail}`,

      description: `Send a future return or product-issue request to ${businessConfig.supportEmail}.`,
    },
  ],
};
...
export const accessibilityStatement: LegalDocument = {
  ...
  description: `Learn about the ${businessConfig.shortName} commitment to creating a website that is welcoming and usable for more people.`,

  introduction: `${businessConfig.publicName} is committed to improving the accessibility and usability of its website. Accessibility is treated as an ongoing design, development, testing, and content responsibility rather than a claim of complete or permanent conformity.`,
  ...
  relatedLinks: [
    {
      ...
      description: 'Report a website or accessibility concern.',
    },

    {
      ...
      description: `Send an accessibility concern to ${businessConfig.generalEmail}.`,
    },

    {
      ...
      description: 'Learn how contact-form information is handled.',
    },
  ],
};
