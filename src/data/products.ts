...
const demoProducts: Product[] = [
...

    {
        ...
        materials: [
            'Demo woven polyester',
            'Demo breathable mesh',
            'Demo metal attachment ring',
        ],
