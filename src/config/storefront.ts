...
export const storefrontMode: StorefrontMode = configuredMode === 'live' ? 'live' : 'prelaunch';

const storefrontStates: Record<StorefrontMode, StorefrontState> = {
  prelaunch: {
    announcement: {
      message: `Explore practical pet guides and get first access to the ${businessConfig.shortName} collection.`,

      href: '/#maxi-pawz-updates',

      ariaLabel: `Get ${businessConfig.shortName} updates and first access`,
    },
  ...
  live: {
    announcement: {
      message: 'Toys, accessories, and everyday essentials for happier pet moments.',

      href: '/shop',

      ariaLabel: `Shop ${businessConfig.shortName} pet products`,
    },
