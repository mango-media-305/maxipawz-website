...
export default function CheckoutButton({ lines, compact = false }: Props) {
  ...
  let buttonLabel = 'Checkout Not Ready';
  ...
  return (
    <div>
      ...
      <div id={statusId} className={compact ? 'mt-3' : 'mt-4'} aria-live="polite">
        {!checkoutReady &&
          ...
          (compact ? (
            <div className="rounded-2xl border border-accent-200 bg-accent-50 p-3">
              <p className="text-xs font-bold leading-5 text-ink-700">
                ...
                {displayedReasons.length > 1 && (
                  <span className="ml-1 text-ink-500">
                    +{displayedReasons.length - 1} more requirements.
                  </span>
                )}
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-accent-200 bg-accent-50 p-4">
              <p className="text-sm font-extrabold text-ink-800">Checkout requirements</p>
